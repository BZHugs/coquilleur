CodeMirror.defineMode("asm64", function ()
{
	...
	var keywords2 = /^(syscall|call|int|iret|ret|ja|jae|jb|jbe|jc|je|jg|jge|jl|jle|jmp|jna|jnae|jnb|jnbe|jnc|jne|jng|jnge|jnl|jnle|jno|jns|jnz|jo|js|jz)\b/i;
	var keywords3 = /^((r|e)?[abcd]x|r(8|9|10|11|12|13|14|15)(d|w|b)?|[abcd][lh]|r?(si|di|bp|sp)|rip)\b/i;
